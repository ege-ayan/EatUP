            ...
            <Card className="shadow-xl border-0 bg-white/90 backdrop-blur-sm animate-fade-in-up">
              <CardContent className="pt-8 pb-8 text-center">
                ...
                <p className="text-gray-600 mb-4 text-base">
                  EatUP hesabınız başarıyla oluşturuldu.
                </p>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                  ...
                  <p className="text-xs text-blue-700 leading-relaxed">
                    Size bir onay e-postası gönderdik. Hesabınızı aktifleştirmek ve giriş yapabilmek için lütfen e-postanızdaki bağlantıya tıklayın.
                  </p>
                </div>
